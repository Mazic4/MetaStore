...
class Trainer_text(object):
    ...
    def build_data(self):
        ...
        self.lab_dataset, self.unlabeled, self.test_dataset, self.dev_dataset = get_dataset_text_noisy(self.args, tokenizer)
    ...
    def train(self, epoch):
        ...
        for _, (_idx, lab_inputs, label, _) in tqdm(enumerate(self.train_dataloader)):
            ...
            loss = self.naive_lab_loss(lab_logits, label).mean()
    ...
    def main(self):
        ...
        for epoch in range(self.args.n_epochs):
            ...
            torch.save(self.model.state_dict(),
                       '/home/zhanghuayi01/TED/ted_v2/model_trainers/models/bert_models/agnews_state_dict_finetune_{}_{}.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lr", type=float, default=1e-4, help="sgd: learning rate")
    ...
    parser.add_argument("--hidden_size", type=int, default=192, help="the number of hidden size in bert")
